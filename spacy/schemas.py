...
class ConfigSchemaInit(BaseModel):
    ...
    tokenizer: Dict[StrictStr, Any] = Field(
        ...,
        json_schema_extra={
            "help": "Arguments to be passed into Tokenizer.initialize"
        },
    )
    components: Dict[StrictStr, Dict[StrictStr, Any]] = Field(
        ...,
        json_schema_extra={
            "help": (
                "Arguments for TrainablePipe.initialize methods of pipeline "
                "components, keyed by component"
            )
        },
    )
